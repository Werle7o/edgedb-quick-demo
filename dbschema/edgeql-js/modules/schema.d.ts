...
export declare type $Object_e460ad90b47a11ecaf6c07879d7ca8d5λShape = $.typeutil.flatten<_std.$BaseObjectλShape & {
...
declare type $Object_e460ad90b47a11ecaf6c07879d7ca8d5 = $.ObjectType<"schema::Object", $Object_e460ad90b47a11ecaf6c07879d7ca8d5λShape, null>;
declare const $Object_e460ad90b47a11ecaf6c07879d7ca8d5: $Object_e460ad90b47a11ecaf6c07879d7ca8d5

declare const Object_e460ad90b47a11ecaf6c07879d7ca8d5: $.$expr_PathNode<$.TypeSet<$Object_e460ad90b47a11ecaf6c07879d7ca8d5, $.Cardinality.Many>, null, true> 

export declare type $AnnotationSubjectλShape = $.typeutil.flatten<$Object_e460ad90b47a11ecaf6c07879d7ca8d5λShape & {
...
export declare type $SubclassableObjectλShape = $.typeutil.flatten<$Object_e460ad90b47a11ecaf6c07879d7ca8d5λShape & {
...
export declare type $AnnotationλShape = $.typeutil.flatten<$Object_e460ad90b47a11ecaf6c07879d7ca8d5λShape & $InheritingObjectλShape & {
...
export declare type $TypeλShape = $.typeutil.flatten<$SubclassableObjectλShape & $AnnotationSubjectλShape & {
  ...
  "<__type__[is std::Object]": $.LinkDesc<_std.$Object_e3d474f6b47a11ec86ef4b7e0fb7045b, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is std::FreeObject]": $.LinkDesc<_std.$FreeObject, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is schema::Object]": $.LinkDesc<$Object_e460ad90b47a11ecaf6c07879d7ca8d5, $.Cardinality.Many, {}, false, false,  false, false>;
  ...
  "<__type__[is Content]": $.LinkDesc<_default.$Content, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Movie]": $.LinkDesc<_default.$Movie, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Show]": $.LinkDesc<_default.$Show, $.Cardinality.Many, {}, false, false,  false, false>;
...
export declare type $VolatilitySubjectλShape = $.typeutil.flatten<$Object_e460ad90b47a11ecaf6c07879d7ca8d5λShape & {
...
export declare type $ConsistencySubjectλShape = $.typeutil.flatten<$Object_e460ad90b47a11ecaf6c07879d7ca8d5λShape & $InheritingObjectλShape & $AnnotationSubjectλShape & {
...
export declare type $DeltaλShape = $.typeutil.flatten<$Object_e460ad90b47a11ecaf6c07879d7ca8d5λShape & {
...
export declare type $ExtensionλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_e460ad90b47a11ecaf6c07879d7ca8d5λShape & {
...
export declare type $SourceλShape = $.typeutil.flatten<$Object_e460ad90b47a11ecaf6c07879d7ca8d5λShape & {
...
export declare type $MigrationλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_e460ad90b47a11ecaf6c07879d7ca8d5λShape & {
...
export declare type $ModuleλShape = $.typeutil.flatten<$Object_e460ad90b47a11ecaf6c07879d7ca8d5λShape & $AnnotationSubjectλShape & {
}>;
...
export declare type $ParameterλShape = $.typeutil.flatten<$Object_e460ad90b47a11ecaf6c07879d7ca8d5λShape & {
  "type": $.LinkDesc<$Type, $.Cardinality.One, {}, false, false,  false, false>;
...
declare type __defaultExports = {
  ...
  "Object": typeof Object_e460ad90b47a11ecaf6c07879d7ca8d5;
