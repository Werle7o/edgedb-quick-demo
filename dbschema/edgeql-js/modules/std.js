...
const $anyscalar = $.makeType(_.spec, "dcbcce66-b47a-11ec-acd0-e35a7a014ae2", _.syntax.literal);

const $anyreal = $.makeType(_.spec, "dcc25d90-b47a-11ec-bfd2-c15648e914a6", _.syntax.literal);

const $anyfloat = $.makeType(_.spec, "dcc5eac8-b47a-11ec-89fe-f110083e5f9e", _.syntax.literal);

const $anyint = $.makeType(_.spec, "dcc3196a-b47a-11ec-b68e-999a97cc9c28", _.syntax.literal);

const $anynumeric = $.makeType(_.spec, "dcc81154-b47a-11ec-b701-51b56761acc9", _.syntax.literal);
...
const $sequence = $.makeType(_.spec, "dcca38bc-b47a-11ec-a9b9-43ff35276e57", _.syntax.literal);
...
const $BaseObject = $.makeType(_.spec, "e3cd7304-b47a-11ec-b6cb-530e76b527ef", _.syntax.literal);

const BaseObject= _.syntax.$PathNode($.$toSet($BaseObject, $.Cardinality.Many), null, true);

const $Object_e3d474f6b47a11ec86ef4b7e0fb7045b = $.makeType(_.spec, "e3d474f6-b47a-11ec-86ef-4b7e0fb7045b", _.syntax.literal);

const Object_e3d474f6b47a11ec86ef4b7e0fb7045b= _.syntax.$PathNode($.$toSet($Object_e3d474f6b47a11ec86ef4b7e0fb7045b, $.Cardinality.Many), null, true);

const $FreeObject = $.makeType(_.spec, "e3dd21c8-b47a-11ec-bfb5-4dc51170d69c", _.syntax.literal);
...
function min(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::min', args, _.spec, [
    {args: [{typeId: "dcc25d90-b47a-11ec-bfd2-c15648e914a6", optional: false, setoftype: true, variadic: false}], returnTypeId: "dcc25d90-b47a-11ec-bfd2-c15648e914a6", returnTypemod: "OptionalType", preservesOptionality: true},
    {args: [{typeId: "dccaf7c0-b47a-11ec-9fe3-4b0da16a175a", optional: false, setoftype: true, variadic: false}], returnTypeId: "dccaf7c0-b47a-11ec-9fe3-4b0da16a175a", returnTypemod: "OptionalType", preservesOptionality: true},
...
function sequence_reset(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
    {args: [{typeId: "e7ce5d9c-b47a-11ec-830c-cdda3af1c371", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
    {args: [{typeId: "e7ce5d9c-b47a-11ec-830c-cdda3af1c371", optional: false, setoftype: false, variadic: false}, {typeId: "00000000-0000-0000-0000-0000000001ff", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
Object.assign(exports, { $anyscalar: $anyscalar, $anyreal: $anyreal, $anyfloat: $anyfloat, $anyint: $anyint, $anynumeric: $anynumeric, bigint: bigint, bool: bool, bytes: bytes, datetime: datetime, decimal: decimal, duration: duration, float32: float32, float64: float64, int16: int16, int32: int32, int64: int64, json: json, $sequence: $sequence, str: str, uuid: uuid, number: number, $BaseObject: $BaseObject, BaseObject: BaseObject, $Object_e3d474f6b47a11ec86ef4b7e0fb7045b: $Object_e3d474f6b47a11ec86ef4b7e0fb7045b, Object_e3d474f6b47a11ec86ef4b7e0fb7045b: Object_e3d474f6b47a11ec86ef4b7e0fb7045b, $FreeObject: $FreeObject, FreeObject: FreeObject });
...
const __defaultExports = {
  ...
  "Object": Object_e3d474f6b47a11ec86ef4b7e0fb7045b,
